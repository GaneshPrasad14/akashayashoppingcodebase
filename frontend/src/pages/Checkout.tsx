  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.paymentMethod === 'Online') {
        ...
        const orderRes = await fetch(`${API_BASE_URL}/orders/razorpay-order`, {
          method: "POST",
        ...
        const options = {
          key: import.meta.env.VITE_RAZORPAY_KEY_ID || "rzp_live_S1eWlOseoFxWUU", // Fallback for dev
              ...
              <div className="bg-card rounded-xl p-6 shadow-sm border">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="p-3 border rounded-md bg-secondary/20 text-sm font-medium flex items-center gap-2">
