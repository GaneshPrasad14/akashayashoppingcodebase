...
const GoldWinnersAdmin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setDialogOpen(false);
        setForm({ name: "", district: "", prize: "5 Gram Gold Coin", prizeType: "first" });
          ...
          <div className="flex items-center justify-between">
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              <DialogTrigger asChild>
                <Button onClick={() => { setEditingWinner(null); setForm({ name: "", district: "", prize: "5 Gram Gold Coin", prizeType: "first" }); }}>
              ...
              <DialogContent className="max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="prizeType">Prize Category *</Label>
                    <Select
                  ...
                  <div key={winner._id} className="border rounded-xl p-4 hover:shadow-md transition-shadow">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <div className={`w-12 h-12 rounded-full flex items-center justify-center ${winner.prizeType === "first"
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-400">{winner.orderId}</p>
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center gap-2 mb-2">
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${winner.prizeType === "first"
