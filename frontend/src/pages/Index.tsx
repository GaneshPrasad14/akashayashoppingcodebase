                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                  <div className="space-y-8 animate-fade-in-up">
                    ...
                    <p className="text-xl text-muted-foreground leading-relaxed max-w-lg">
                      ...
                      <span className="text-primary font-medium block mt-2">Win Gold Coins with every lucky purchase!</span>
                    </p>
              ...
              <div className="container relative z-10">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="relative flex justify-center items-center">
                    {/* Glowing Gold Effect */}
                    <div className="absolute inset-0 bg-yellow-400/20 blur-[100px] rounded-full mix-blend-multiply" />

                    <div className="relative z-10 flex items-center justify-center w-full max-w-2xl px-4 mt-8 md:mt-0">
                      {/* 5g Coin - Main */}
                      <div className="relative z-20 hover:scale-110 transition-transform duration-500 animate-float">
                        <img
                          src="/5g.png"
                          alt="5g Gold Coin - 1st Prize"
                          className="w-[180px] h-[180px] md:w-[320px] md:h-[320px] object-contain drop-shadow-2xl rounded-full border-4 border-yellow-200/50"
                        />
                      ...
                      {/* 1g Coin - Secondary - Slight Overlap */}
                      <div className="relative z-10 -ml-12 md:-ml-20 mt-12 hover:scale-110 transition-transform duration-500 animate-float" style={{ animationDelay: '1s' }}>
                        <img
                          src="/1g.png"
                          alt="1g Gold Coin - Runners Up"
                          className="w-[140px] h-[140px] md:w-[240px] md:h-[240px] object-contain drop-shadow-xl rounded-full border-4 border-yellow-200/50 grayscale-[10%]"
                        />
                        <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur px-4 py-2 md:px-6 md:py-2 rounded-full shadow-xl border border-yellow-100 whitespace-nowrap z-30">
