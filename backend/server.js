...
app.use(helmet({
  ...
  contentSecurityPolicy: {
    directives: {
      defaultSrc: ["'self'"],
      imgSrc: ["'self'", "data:", "blob:", "https://akshaya-backend-kjdp.onrender.com", "http://localhost:5035"],
      scriptSrc: ["'self'", "'unsafe-inline'"],
      connectSrc: ["'self'", "https://akshaya-backend-kjdp.onrender.com", "http://localhost:5035"]
    }
  }
}));
